...
- (SA_OAuthTwitterEngine *) initOAuthWithDelegate: (NSObject *) delegate {
    if ((self = (SA_OAuthTwitterEngine *)[super initWithDelegate: delegate])) {
...
// modificaiton from the base class
...
//							  timeoutInterval:URL_REQUEST_TIMEOUT];
    ...
    OAMutableURLRequest *theRequest = [[[OAMutableURLRequest alloc] initWithURL:finalURL consumer:self.consumer token:_accessToken realm: nil signatureProvider:nil] autorelease];
    if (method) {
